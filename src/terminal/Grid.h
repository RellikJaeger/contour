...
struct Margin
{
    ...
    {
		ColumnOffset from;
		ColumnOffset to; // TODO(pr) call it begin and end and have end point to to+1 to avoid unnecessary +1's later
    ...
    {
		LineOffset from;
		LineOffset to; // TODO(pr) call it begin and end and have end point to to+1 to avoid unnecessary +1's later
...
struct LogicalLine
{
    ...
    {
        // TODO(pr): determin final line's column count and pass it to ctor.
...
class Grid
{
// TODO(pr): Rename all "History" to "Scrollback"?
public:
    ...
    // TODO(pr): LogicalLines<Cell const> logicalLines() const;
