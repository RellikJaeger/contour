...
constexpr ParserTable ParserTable::get() // {{{
{
    ...
    {
        // TODO: The UTF-8 versions of the C1 controls (0x80..0x9F)
        //       should be integrated into the VT parser FSM.
...
void Parser<EventListener>::handle(ActionClass _actionClass, Action _action, char _char)
{
    ...
    // fmt::print("VTParser.handle: {} {} {} 0x{:02X}\n",
    //            state_, _actionClass, _action, static_cast<uint8_t>(_char) & 0xFF);
