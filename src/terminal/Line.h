...
public:
    ...
    //#define LINE_AVOID_CELL_RESET 1 // TODO(pr): This is experimental (aka. buggy)

    void reset(LineFlags _flags, GraphicsAttributes _attributes) noexcept // TODO(pr): optimize by having no need to O(n) iterate through all buffer cells.
    {
        flags_ = static_cast<unsigned>(_flags);
        ...
        //         // TODO(pr) also styles and UL color
